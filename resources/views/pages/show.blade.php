      ...
      <div class="row">
        <div class="col-md-8">
          ...
          <div class="top-comment"><!--top comment-->
            <img src="{{$post->author->getAvatar()}}" width="80" class="pull-left img-circle" alt="">
...
{{--                <h4>3 comments</h4>--}}
                ...
                <div class="comment-img">
                  <img class="img-circle" width="80" src="{{$comment->author->getAvatar()}}" alt="">
                </div>
